...
<header>
                ...
                <nav class="navbar navbar-expand-sm navbar-dark">
                    ...
                    <div class="navbar-brand col-2 offset-1">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="createSending.php">Crear salidas</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="entrance.php">Entrada</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="Incidence.php">Incidencias</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="prueba col-5 align-self-center">
                <div class="row justify-content-center"><!-- Se tiene que copiar desde aqui -->
                    <div class=" prueba1 col-6 align-self-center">
                        <form id="inci">
