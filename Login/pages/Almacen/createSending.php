...
<body>
  ...
  <form>
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="titulo" placeholder="Ingrese un título para el titulo">
    </div>
    <div class="form-group">
      <label for="descripcion">Descripción</label>
      <textarea class="form-control" id="descripcion" rows="3" placeholder="Ingrese una descripción para el pedido"></textarea>
    </div>
