        ...
        <form>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-3"><input type="text" class="form-control" id="titulo" placeholder="Codigo tienda"></div>
                </div>
            </div>
            <button style="margin-bottom:10px" type="submit" class="btn btn-primary">Anadir productos</button><br>
